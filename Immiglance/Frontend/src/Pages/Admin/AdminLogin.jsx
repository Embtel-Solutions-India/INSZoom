...
export default function AdminLogin() {
  ...
  useEffect(() => {
    document.title = "Admin Login | Immiglance Portal";
      ...
      <div className={`flex-1 flex flex-col justify-center px-8 sm:px-12 lg:px-20 py-12 bg-slate-900
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="flex items-center gap-3 mb-10">
            ...
            <div>
              <p className="text-lg font-extrabold text-white leading-none">Immiglance</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                placeholder="admin@immiglance.com" autoComplete="email" required
          ...
          <p className="mt-10 text-center text-xs text-slate-600">
            © {new Date().getFullYear()} Immiglance (Immiglance) · Admin Panel
          </p>
        </div>
      </div>
