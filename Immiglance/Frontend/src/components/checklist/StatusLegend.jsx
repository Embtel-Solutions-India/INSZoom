...
export default function StatusLegend({ className = "" }) {
  return (
    <div className={`flex flex-wrap items-center gap-2 rounded-xl border border-border bg-card px-3 py-2.5 ${className}`} aria-label="Checklist status legend">
      <span className="mr-1 text-[0.7rem] font-bold uppercase tracking-wide text-muted-foreground">Status:</span>
