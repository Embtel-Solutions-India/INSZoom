...
// (identical polyline path data, not just a similar-looking icon). Used
// everywhere the logo appears (navbar, login page, home) so there is exactly
// one place that defines what "the Immiglance logo" looks like, instead of
// every surface drawing its own approximation. Inlined as raw SVG (same path
// data as lucide-react's TrendingUp icon) rather than importing lucide-react,
// since this app has no lucide-react dependency and one 6-line icon isn't
