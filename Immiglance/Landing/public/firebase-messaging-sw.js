...
// project identifiers, not secrets — see Firebase's own docs) for the Immiglance
...
// Immiglance/Frontend/.env's VITE_FIREBASE_* values by hand.
...
// Fires only when no Immiglance tab is focused (foreground messages are handled
