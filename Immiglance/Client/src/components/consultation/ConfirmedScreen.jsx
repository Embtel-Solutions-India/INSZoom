...
// Adapted from Landing's own ConfirmedScreen: "Return to home" here means
// this app's own home (the Overview dashboard), not Landing's marketing
// homepage — this whole booking flow now runs entirely inside the Client
// app, so "home" for a signed-in client is /dashboard.
export default function ConfirmedScreen({ booking }) {
  ...
  return (
    <div className="text-center py-8">
      ...
      <h2 className="text-xl font-bold text-foreground mb-2">You're booked!</h2>
