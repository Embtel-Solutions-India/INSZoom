...
// Labels match the Immiglance reference's client-facing document vocabulary
// (Requested / Pending Review / Approved / Rejected) — applied to both
// document and field items since they share one status pipeline; the
// underlying STATUS keys and server-driven derivation are unchanged.
