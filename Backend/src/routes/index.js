...
router.use("/analytics", require("../middleware/requireFeature")("analytics"), require("../modules/dashboard/analytics.routes"));
...
router.use("/branches", require("../modules/settings/branches.routes"));
