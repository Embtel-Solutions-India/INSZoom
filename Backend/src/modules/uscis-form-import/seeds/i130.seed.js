// node src/modules/uscis-form-import/seeds/i130.seed.js
// (or: npm run seed:i130, from Backend/)
//
// Imports (if not already present) and activates the bundled I-130
// (edition 2024-04-01) so uscis-form.service.js's
// latestTemplatesByAssignmentRules()/templateAppliesToCase() will assign it
// to K-3 and I-130 cases. Idempotent and non-destructive.
...
const TITLE = "Petition for Alien Relative (I-130)";
const DEFAULT_FILE = path.resolve(__dirname, "../../../../dev-assets/uscis/i-130_2024-04-01.pdf");
...
async function seedI130Template({ file } = {}) {
...
module.exports = seedI130Template;

if (require.main === module) {
  mongoose
    .connect(env.mongoUri)
    .then(() => seedI130Template({}))
