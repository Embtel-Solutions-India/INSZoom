// node src/modules/uscis-form-import/seeds/i539a.seed.js
// (or: npm run seed:i539a, from Backend/)
//
// Imports (if not already present) and activates the bundled I-539A
// (edition 2024-08-28). Conditional assignment picks this form by formCode.
...
const FORM_CODE = "I-539A";
const VERSION = "2024-08-28";
const EDITION_DATE = new Date("2024-08-28T00:00:00.000Z");
const TITLE = "Supplemental Information for Application to Extend/Change Nonimmigrant Status (I-539A)";
const DEFAULT_FILE = path.resolve(__dirname, "../../../../dev-assets/uscis/i-539a_2024-08-28.pdf");
...
async function seedI539ATemplate({ file } = {}) {
  ...
  // this change - I-539A (H-4/L-2 dependents) was unreachable for every
...
module.exports = seedI539ATemplate;

if (require.main === module) {
  mongoose
    .connect(env.mongoUri)
    .then(() => seedI539ATemplate({}))
