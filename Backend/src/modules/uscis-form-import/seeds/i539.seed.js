// node src/modules/uscis-form-import/seeds/i539.seed.js
// (or: npm run seed:i539, from Backend/)
//
// Imports (if not already present) and activates the bundled I-539
...
const TITLE = "Application to Extend/Change Nonimmigrant Status (I-539)";
const DEFAULT_FILE = path.resolve(__dirname, "../../../../dev-assets/uscis/i-539_2024-08-28.pdf");
...
async function seedI539Template({ file } = {}) {
...
module.exports = seedI539Template;

if (require.main === module) {
  mongoose
    .connect(env.mongoUri)
    .then(() => seedI539Template({}))
