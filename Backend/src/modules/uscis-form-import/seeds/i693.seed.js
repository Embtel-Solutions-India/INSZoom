// node src/modules/uscis-form-import/seeds/i693.seed.js
// (or: npm run seed:i693, from Backend/)
//
// Imports (if not already present) and activates the bundled I-693
// (edition 2025-01-20) so registry-driven provisioning
// (VisaFormMapping's formTemplateFormCode: "i-693") can attach it wherever
// a case's processingPath is ADJUSTMENT_OF_STATUS. Idempotent and
// non-destructive — mirrors i134.seed.js.
...
const TITLE = "Report of Immigration Medical Examination and Vaccination Record (I-693)";
const DEFAULT_FILE = path.resolve(__dirname, "../../../../dev-assets/uscis/i-693_2025_20_01.pdf");
const MIN_FIELD_COUNT = 10;
const VISA_TYPES = [
  "EB-1A", "EB-1B", "EB-1C", "EB-2 PERM", "EB-2 NIW",
  "EB-3 Skilled Worker", "EB-3 Professional", "EB-3 Other Worker",
  "EB-5 Regional Center", "EB-5 Standalone", "Adjustment of Status",
];
...
async function seedI693Template({ file } = {}) {
...
module.exports = seedI693Template;

if (require.main === module) {
  mongoose
    .connect(env.mongoUri)
    .then(() => seedI693Template({}))
