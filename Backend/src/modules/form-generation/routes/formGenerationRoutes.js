...
router.get("/:caseFormId/draft-pdf", authorizePermissions("forms:read"), requireCaseFormAccess, controller.draftPdf);
router.get("/:caseFormId/filing-pdf", authorizePermissions("forms:read"), requireCaseFormAccess, controller.filingPdf);
