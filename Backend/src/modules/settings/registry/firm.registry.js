...
module.exports = [
  ...
  { key: "firm.logo", category: "firm", group: "Identity", label: "Logo (S3 key)", type: "string", default: "", validation: z.string().max(2000), scopes: ["system"], requiresPermission: "settings:manage_firm", affects: "INSZoom header, client portal header, invoice header, PDF letterhead" },
  ...
  { key: "firm.primaryColor", category: "firm", group: "Brand", label: "Brand color", type: "color", default: "#10b981", validation: z.string().regex(/^#(?:[0-9a-fA-F]{3}){1,2}$/), scopes: ["system"], requiresPermission: "settings:manage_firm", affects: "INSZoom/client-portal theme CSS variable, invoice accent (frontend wiring not built this pass)" },
];
