...
function bodyLines(data = {}) {
  ...
  return [
    ...
    `<strong>${data.petitionerName || "Your petitioner"}</strong> has included you in a family immigration case and has invited you to complete your personal information on the Immiglance portal.`,
